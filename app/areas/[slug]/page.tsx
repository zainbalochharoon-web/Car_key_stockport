...
export default async function LocationPage({ params }: LocationPageProps) {
  ...
  const breadcrumbItems = [
    ...
    { name: location.name, url: `/areas/stockport/${slug}` },
  ]
    ...
    <>
      ...
      <Breadcrumb
        items={[
          ...
          { name: location.name, href: `/areas/stockport/${slug}` },
        ]}
      />
        ...
        <div className="container-custom">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto">
            {areaSlugs
              ...
              .slice(0, 6)
              .map((s) => (
                <Link key={s} href={`/areas/stockport/${s}`} className="card p-5 hover:bg-slate-700 transition-colors">
