...
const stockportLocalBusinessSchema = {
  ...
  areaServed: [
    ...
    { "@type": "City", name: "Marple" },
    { "@type": "City", name: "Romiley" },
    { "@type": "City", name: "Bredbury" },
    { "@type": "City", name: "Offerton" },
    { "@type": "City", name: "Edgeley" },
    { "@type": "City", name: "Davenport" },
    { "@type": "City", name: "Heaton Mersey" },
    { "@type": "City", name: "Heaton Moor" },
  ],
}
    ...
    <>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            webPageSchema({
              name: "Auto Locksmith Stockport | Car Keys in Stockport",
              description:
                "Professional mobile auto locksmith services across Stockport and Greater Manchester. Car key replacement, emergency lockout, van lockout, key fob programming. 24/7. No call-out fee.",
              url: "/areas/stockport",
      ...
      />
      <Script
        id="stockport-breadcrumb-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema([
