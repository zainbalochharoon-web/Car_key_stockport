...
export const metadata: Metadata = {
  title: "Car Locksmith Stockport | Vikki Heaton – 25-Min Response, No Call-Out Fee",
  description:
  ...
  twitter: {
    ...
    title: "Car Locksmith Stockport | Vikki Heaton – 25-Min Response, No Call-Out Fee",
    description:
      "Lost car keys or locked out in Stockport? Vikki Heaton — female auto locksmith since 2016 — arrives in 25 minutes. 24/7, no call-out fee.",
...
// FAQ Data — optimised for Google AI Overviews, PAA, voice search, and LLM citation
const faqData = [
  {
    question: "How much does car key replacement cost in Stockport?",
    answer:
      "Car key replacement in Stockport typically costs £80–£250 depending on the vehicle make, model, and key type. A standard blade key is the cheapest option; transponder keys and smart keys cost more due to the programming required. Car Keys in Stockport provides a fixed upfront price with no call-out fee — call 07309903243 for an instant quote based on your specific vehicle.",
  },
  {
    question: "How quickly can an auto locksmith reach me in Stockport?",
    answer:
      "Car Keys in Stockport averages a 25-minute response time across Stockport and Greater Manchester. Vikki Heaton operates as a mobile auto locksmith, travelling directly to your location — whether you're at home, at work, in a car park, or at the roadside — 24 hours a day, 7 days a week.",
  },
  {
    question: "Can a locksmith make a car key without the original?",
    answer:
      "Yes. A qualified auto locksmith can produce a fully functional replacement car key without the original, using specialist key-cutting and programming equipment. Car Keys in Stockport uses the vehicle's VIN and ECU data to cut and program new keys on-site, meaning you do not need to keep the original key.",
  },
  {
    question: "Is it cheaper to use a locksmith or a main dealer for car key replacement?",
    answer:
      "A mobile auto locksmith is typically 40–60% cheaper than a main dealer for car key replacement. Dealers charge premium labour rates and often require the vehicle to be transported to them. Car Keys in Stockport cuts and programs keys on-site, same day, at your location — with no call-out fee.",
  },
  {
    question: "What vehicles does Car Keys in Stockport cover?",
    answer:
      "Car Keys in Stockport covers all major vehicle makes including Ford, Vauxhall, BMW, Mercedes-Benz, Audi, Volkswagen, Toyota, Renault, Nissan, Tesla, Kia, Hyundai, Honda, and more. Both cars and vans are covered. Transponder keys, smart keys, remote key fobs, and blade keys are all handled.",
  },
  {
    question: "Do you charge a call-out fee for emergency locksmith services?",
    answer:
      "No. Car Keys in Stockport does not charge a call-out fee for any service, including 24/7 emergency lockouts. You receive a fixed price before work begins — no hidden charges. Car key replacement typically costs £80–£250 and lockout assistance £60–£150.",
  },
  {
    question: "What is a transponder key and why does it cost more to replace?",
    answer:
      "A transponder key contains a microchip that communicates with the vehicle's immobiliser system. When inserted, the chip transmits a code that authorises the engine to start. Programming this chip requires specialist diagnostic equipment, which is why transponder key replacement costs more than a standard blade key. Most vehicles made after 1995 use transponder keys.",
  },
  {
    question: "Can you help with van lockouts in Stockport?",
    answer:
      "Yes. Car Keys in Stockport provides van lockout assistance and van key replacement for all commercial and personal vans, including Ford Transit, Mercedes Sprinter, Vauxhall Vivaro, and Volkswagen Transporter. Van lockout service is available 24/7 across Stockport, Hazel Grove, and Greater Manchester.",
  },
]
