...
import { organizationSchema, webSiteSchema, vikkiHeatonPersonSchema } from "@/lib/schema"
  ...
  return (
    <html lang="en-GB">
      ...
      <body className={inter.className}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <address className="not-italic">
                  <div className="flex items-center gap-2 text-gray-400 mb-2">
                    ...
                    <span className="text-xs sm:text-sm">Stockport, Greater Manchester, SK1</span>
                  </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li>
                    <Link href="/services/testimonials" className="hover:text-orange-400 transition-colors text-xs sm:text-sm">
                      Customer Reviews
                    </Link>
                  </li>
                  <li>
        ...
        {/* JSON-LD — Global entity graph: Business + Website + Founder */}
        {/* Single canonical emission — page-level schemas extend this via @id reference */}
        <script
