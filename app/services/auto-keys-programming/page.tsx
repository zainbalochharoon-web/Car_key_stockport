...
const autoKeysFaqs = [
  {
    question: "What is auto key programming in Stockport?",
    answer:
      "Auto key programming is the process of synchronising a new car key's microchip (transponder) with the vehicle's immobiliser and ECU. Without programming, the key will turn in the ignition but the engine will not start. Car Keys in Stockport programs auto keys on-site for all vehicle makes using specialist diagnostic equipment.",
  },
  {
    question: "How much does auto key programming cost in Stockport?",
    answer:
      "Auto key programming in Stockport costs £80–£250 depending on the vehicle make and key type. A fixed upfront price is provided before any work begins. There is no call-out fee. Call 07309903243 for an instant quote.",
  },
  {
    question: "Can you program auto keys on the spot without taking my car away?",
    answer:
      "Yes. Car Keys in Stockport is a fully mobile service. Vikki Heaton programs auto keys at your location — home, work, or roadside — using equipment carried in the mobile unit. No dealer visit, no towing.",
  },
]

export const metadata: Metadata = {
  title: "Auto Key Programming Stockport | Transponder Keys On-Site | 25-Min Response",
  description:
    "Auto key programming in Stockport — transponder keys, smart keys, and remotes programmed at your location. Average 25-minute response. Fully insured. No call-out fee. Call 07309903243.",
  alternates: {
...
export default function AutoKeysProgrammingPage() {
  return (
    <>
      <Script
        id="auto-keys-service-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema({
              name: "Auto Keys Programming Stockport",
              description:
                "Mobile auto key programming service across Stockport and Greater Manchester. Transponder key cutting and ECU programming for all vehicle makes. On-site service — no dealer visit required. No call-out fee.",
              url: "/services/auto-keys-programming",
      ...
      />
      <Script
        id="auto-keys-faq-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema(autoKeysFaqs)) }}
      />
      <Script
        id="auto-keys-breadcrumb-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema([
              ...
              { name: "Auto Keys Programming", url: "/services/auto-keys-programming" },
            ])
          ),
        }}
      />
