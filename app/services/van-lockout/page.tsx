...
const vanLockoutFaqs = [
  {
    question: "How quickly can you reach me for a van lockout in Stockport?",
    answer:
      "Car Keys in Stockport averages a 25-minute response time for van lockouts across Stockport and Greater Manchester. Vikki Heaton operates a fully equipped mobile unit and travels directly to your location — whether that's a business premises, a car park, or the roadside.",
  },
  {
    question: "Which vans can you unlock without causing damage?",
    answer:
      "Car Keys in Stockport provides non-destructive van entry for all major commercial and personal vans including Ford Transit, Mercedes Sprinter, Vauxhall Vivaro, Volkswagen Transporter, Renault Trafic, Peugeot Expert, Citroën Dispatch, Fiat Ducato, and all other makes. Specialist non-destructive entry tools are used on every job.",
  },
  {
  ...
  {
    question: "Do you provide van lockout assistance 24 hours a day?",
    answer:
      "Yes. Van lockout service is available 24 hours a day, 7 days a week, including bank holidays and Christmas Day. Commercial van lockouts are treated as emergencies — business downtime is costly, and Car Keys in Stockport aims to get you back on the road as quickly as possible.",
  },
]
...
export default function VanLockoutPage() {
  return (
    <>
      <Script
        id="van-lockout-service-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema({
              name: "Van Lockout Assistance Stockport",
              description:
                "24/7 emergency van lockout service across Stockport and Greater Manchester. Non-destructive entry for all van makes including Ford Transit, Mercedes Sprinter, Vauxhall Vivaro, VW Transporter. Average 25-minute response. No call-out fee. Fully insured.",
              url: "/services/van-lockout",
      ...
      />
      <Script
        id="van-lockout-faq-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema(vanLockoutFaqs)) }}
      />
      <Script
        id="van-lockout-breadcrumb-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema([
              ...
              { name: "Van Lockout", url: "/services/van-lockout" },
            ])
          ),
        }}
      />
