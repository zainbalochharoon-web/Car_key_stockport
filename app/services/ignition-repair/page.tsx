...
const ignitionFaqs = [
  {
    question: "Can a locksmith fix my car ignition in Stockport?",
    answer:
      "Yes. Car Keys in Stockport provides mobile ignition repair and ignition barrel replacement for all vehicle makes. Common issues include a worn or stuck ignition barrel, keys that turn but won't start the engine, and ignition switches that won't turn. Vikki Heaton diagnoses the fault on-site and provides a fixed price before any work begins.",
  },
  {
    question: "How much does ignition repair cost in Stockport?",
    answer:
      "Ignition repair in Stockport costs £80–£200 depending on the fault, vehicle make, and whether a barrel replacement is required. A fixed upfront price is provided before work begins. There is no call-out fee.",
  },
  {
    question: "How long does ignition repair take?",
    answer:
      "Most ignition repairs and barrel replacements are completed within 30–60 minutes on-site. Car Keys in Stockport carries ignition parts for the most common vehicle makes in the mobile unit.",
  },
]

export const metadata: Metadata = {
  title: "Ignition Repair Stockport | Mobile Car Locksmith | 25-Min Response",
  description:
    "Ignition repair and barrel replacement in Stockport. On-site fix for broken or faulty ignitions — average 25-minute response. Fully insured. No call-out fee. Call 07309903243.",
  alternates: {
...
export default function IgnitionRepairPage() {
  return (
    <>
      <Script
        id="ignition-service-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema({
              name: "Ignition Repair Stockport",
              description:
                "Mobile ignition repair and ignition barrel replacement across Stockport and Greater Manchester. On-site diagnosis and repair for all vehicle makes. 25-minute average response. No call-out fee.",
              url: "/services/ignition-repair",
      ...
      />
      <Script
        id="ignition-faq-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema(ignitionFaqs)) }}
      />
      <Script
        id="ignition-breadcrumb-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema([
              ...
              { name: "Ignition Repair", url: "/services/ignition-repair" },
            ])
          ),
        }}
      />
