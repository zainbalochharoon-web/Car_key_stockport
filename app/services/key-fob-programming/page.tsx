...
const keyFobFaqs = [
  {
    question: "How long does key fob programming take in Stockport?",
    answer:
      "Key fob programming typically takes 15–30 minutes on-site. Smart keys or proximity keys (keyless entry/start) may take up to 45 minutes. Car Keys in Stockport programs key fobs at your location — home, work, or roadside.",
  },
  {
    question: "Can you program a key fob without the original?",
    answer:
      "Yes. Car Keys in Stockport can program a new key fob without the original using specialist diagnostic equipment and your vehicle's VIN. This includes remote-only fobs, transponder key fobs, and smart keys.",
  },
  {
    question: "How much does key fob programming cost in Stockport?",
    answer:
      "Key fob programming in Stockport costs £80–£200 depending on the vehicle make and fob type. A fixed upfront price is provided before any work begins. There is no call-out fee. Call 07309903243 for an instant quote.",
  },
  {
    question: "Which car brands can you program key fobs for?",
    answer:
      "Car Keys in Stockport programs key fobs for all major brands including Ford, Vauxhall, BMW, Mercedes-Benz, Audi, Volkswagen, Toyota, Nissan, Renault, Kia, Hyundai, and Honda. Specialist programming equipment is carried in the mobile unit.",
  },
]
...
export default function KeyFobProgrammingPage() {
  return (
    <>
      <Script
        id="key-fob-service-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema({
              name: "Key Fob Programming Stockport",
              description:
                "Mobile key fob programming and remote key replacement service across Stockport and Greater Manchester. Transponder keys, smart keys, proximity keys for all major vehicle brands. On-site programming in 15–30 minutes. No call-out fee.",
              url: "/services/key-fob-programming",
      ...
      />
      <Script
        id="key-fob-faq-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema(keyFobFaqs)) }}
      />
      <Script
        id="key-fob-breadcrumb-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema([
              ...
              { name: "Key Fob Programming", url: "/services/key-fob-programming" },
            ])
          ),
        }}
      />
